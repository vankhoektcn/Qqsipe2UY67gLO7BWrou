		...
		<div class="visit-place ">
			...
			<div class="section-detail mrgb3x clearfix">
				...
				<div class="col-md-4 col-sm-6">
					<div class="place-img pointer"> <a href="{{$project->getLink()}}" target="_blank"> <img class="lazy" src="/frontend/images/spacer.gif" data-src="{{ Image::url($project->getFirstImage(),350,225,array('crop'))}}" class="img-responsive" alt="{{$project->name}}"/> </a>
			...
			<div class="section-detail mrgb3x clearfix">
				...
				<div class="col-md-4 col-sm-6">
					<div class="home2 property-box border-hover animated out" data-delay="0" data-animation="fadeInUp">
						<div class="appartment-img"><a href="{{$project->getLink()}}" target="_blank"><img class="lazy" src="/frontend/images/spacer.gif" data-src="{{ Image::url($project->getFirstImage(),350,225,array('crop'))}}" class="img-responsive" alt="{{$project->name}}" /></a>
			...
			@foreach ($agents as $agent)			
				<div class="col-md-3 col-sm-4 mrgb8x animated out" data-delay="0" data-animation="fadeInUp">
					<div class="agent-profile">
						<div class="agent-img"><img class="lazy" src="/frontend/images/spacer.gif" data-src="{{ Image::url($agent->thumnail,215,190,array('crop'))}}" class="img-responsive" alt="#" />
