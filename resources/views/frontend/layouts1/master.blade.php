...
, '/frontend/css1/responsive.css', '/frontend/css1/fotorama.css')) !!}
...
<div class="top-bar" id="main-top-bar">
	<div class="container">
		<div class="left-bar" id="main-left-bar">
		...
		<div class="right-bar">
			<ul class="contact">
				...
				<li class="contact-info"><a href="tel:{{ $config->getValueByKey('headquarter_phone_number') }}">{{ $config->getValueByKey('headquarter_phone_number') }}</a></li>
			</ul>
			<ul class="mail">
...
, '/frontend/js1/jquery.themepunch.tools.min.js', '/frontend/js1/jquery.lazy.min.js', '/frontend/js1/fotorama.js'
