...
@section('head.title', 'Cập nhật thông tin quận/huyện')
...
<div class="page-head">
	...
	<div class="page-title">
		<h1>Cập nhật thông tin quận huyện <small>{{ $district->key }}</small></h1>
	</div>
	<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<a href="{{ route('admin.districts.edit', ['id' => $district->id]) }}">{{ $district->key }}</a>
	</li>
</ul>
<!-- END PAGE BREADCRUMB -->
<!-- END PAGE HEADER-->
	...
	<div class="col-md-12">
		<div class="portlet light bordered">
			<div class="portlet-body form">
				...
				{!! Form::open([
					'id' => 'district-form',
					'route' => ['admin.districts.update', $district->id],
...
<script src="/admin/assets/pages/districts/crazyify.districts.entry.js" type="text/javascript"></script>
@endsection