...
@section('head.title', 'Danh sách quận/huyện')
...
<div class="page-head">
	...
	<div class="page-title">
		<h1>Danh sách quận/huyện <small></small></h1>
	</div>
	<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<a href="{{ route('admin.districts.index') }}">Quận/huyện</a>
		<i class="fa fa-circle"></i>
	</li>
	<li>
		<a href="{{ route('admin.districts.index') }}">Danh sách</a>
	</li>
</ul>
<!-- END PAGE BREADCRUMB -->
<!-- END PAGE HEADER-->
	...
	<div class="col-md-12">
		 <div class="portlet light bordered">
			<div class="portlet-body">
				<table id="tbldistricts" class="table table-striped table-bordered table-hover">
					<thead>
					<tr>
						<th>#</th>
						<th>Quận/huyện</th>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="{{ route('admin.districts.edit', ['district' => $district->id]) }}" class="btn btn-xs green-jungle">
									<i class="fa fa-edit"></i> Sửa
								</a>
								<a href="javascript:;" class="btn btn-xs red-thunderbird action-delete" data-id="{{ $district->id }}">
...
@section('body.js')
<script src="/admin/assets/pages/districts/crazyify.districts.index.js" type="text/javascript"></script>
@endsection