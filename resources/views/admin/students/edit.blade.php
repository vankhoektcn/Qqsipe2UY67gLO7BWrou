...
@section('head.title', 'Chi tiết học viên đăng ký')
...
<div class="page-head">
	...
	<div class="page-title">
		<h1>Chi tiết học viên đăng ký <small>{{ $student->subject }}</small></h1>
	</div>
	<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<a href="{{ route('admin.students.edit', ['id' => $student->id]) }}">{{ $student->subject }}</a>
	</li>
</ul>
<!-- END PAGE BREADCRUMB -->
<!-- END PAGE HEADER-->
				...
				<div class="form-actions">
					<div class="row">
						<div class="col-md-offset-3 col-md-9">
							<a href="mailto:{{ $student->email }}" class="btn green-jungle"><i class="fa fa-envelope-o"></i>&nbsp;Trả lời email</a>
						</div>
					</div>
				</div>
				{!! Form::close() !!}
...
<script src="/admin/assets/pages/students/crazyify.students.entry.js" type="text/javascript"></script>
@endsection