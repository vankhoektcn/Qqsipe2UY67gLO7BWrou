...
@section('head.title', 'Cập nhật môn học')
...
<div class="page-head">
	...
	<div class="page-title">
		<h1>Cập nhật môn học<small>{{ $subject->name }}</small></h1>
	</div>
	<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<a href="{{ route('admin.subjects.index') }}">Hệ thông</a>
		<i class="fa fa-circle"></i>
	</li>
	<li>
		<a href="{{ route('admin.subjects.edit', ['id' => $subject->id]) }}">{{ $subject->name }}</a>
	</li>
</ul>
<!-- END PAGE BREADCRUMB -->
<!-- END PAGE HEADER-->
...
<script src="/admin/assets/pages/subjects/crazyify.subjects.entry.js" type="text/javascript"></script>
@endsection