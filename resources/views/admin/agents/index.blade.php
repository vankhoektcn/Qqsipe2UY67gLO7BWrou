...
<div class="page-head">
	...
	<div class="page-title">
		<h1>Danh sách nhân viên môi giới <small></small></h1>
	</div>
	<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<a href="{{ route('admin.agents.index') }}">Danh sách</a>
	</li>
</ul>
<!-- END PAGE BREADCRUMB -->
<!-- END PAGE HEADER-->
	...
	<div class="col-md-12">
		 <div class="portlet light bordered">
			<div class="portlet-body">
				<table id="tblagents" class="table table-striped table-bordered table-hover">
					<thead>
					<tr>
						<th>#</th>
						<th>Tên nhân viên</th>
					...
					<tbody>
						...
						<tr>
							...
							<td>{{ $agent->name }}</td>
							<td>
								<a href="{{ route('admin.agents.edit', ['agent' => $agent->id]) }}" class="btn btn-xs green-jungle">
									<i class="fa fa-edit"></i> Sửa
								</a>
								<a href="javascript:;" class="btn btn-xs red-thunderbird action-delete" data-id="{{ $agent->id }}">
...
@section('body.js')
<script src="/admin/assets/pages/agents/crazyify.agents.index.js" type="text/javascript"></script>
@endsection