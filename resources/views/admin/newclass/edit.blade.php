...
@section('head.title', 'Cập nhật thông tin lớp học')
...
<div class="page-head">
	...
	<div class="page-title">
		<h1>Cập nhật thông tin quận huyện <small>{{ $newclass->name }}</small></h1>
	</div>
	<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<a href="{{ route('admin.newclass.index') }}">lớp học</a>
		<i class="fa fa-circle"></i>
	</li>
	<li>
		<a href="{{ route('admin.newclass.edit', ['id' => $newclass->id]) }}">{{ $newclass->name }}</a>
	</li>
</ul>
<!-- END PAGE BREADCRUMB -->
<!-- END PAGE HEADER-->
	...
	<div class="col-md-12">
		<div class="portlet light bordered">
			<div class="portlet-body form">
				...
				{!! Form::open([
					'id' => 'newclass-form',
					'route' => ['admin.newclass.update', $newclass->id],
...
<script src="/admin/assets/pages/newclass/crazyify.newclass.entry.js" type="text/javascript"></script>
@endsection