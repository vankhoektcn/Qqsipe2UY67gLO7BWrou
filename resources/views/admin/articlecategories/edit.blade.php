...
@section('head.title', 'Cập nhật danh mục bài viết')
...
<div class="page-head">
	...
	<div class="page-title">
		<h1>Danh mục bài viết <small>{{ $articleCategory->name }}</small></h1>
	</div>
	<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<a href="{{ route('admin.articlecategories.edit', ['id' => $articleCategory->id]) }}">{{ $articleCategory->name }}</a>
	</li>
</ul>
<!-- END PAGE BREADCRUMB -->
<!-- END PAGE HEADER-->
		...
		<div class="portlet light bordered">
			<div class="portlet-body form">
				...
				{!! Form::open([
					...
					'route' => ['admin.articlecategories.update', $articleCategory->id],
...
<script src="/admin/assets/pages/articlecategories/crazyify.articlecategories.entry.js" type="text/javascript"></script>
@endsection