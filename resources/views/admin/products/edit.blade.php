...
@section('head.title', 'Cập nhật tin đăng')
...
<div class="page-head">
	...
	<div class="page-title">
		<h1>Tin đăng <small>{{ $product->title }}</small></h1>
	</div>
	<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<a href="{{ route('admin.products.index') }}">Danh mục tin đăng</a>
		<i class="fa fa-circle"></i>
	</li>
	<li>
		<a href="{{ route('admin.products.edit', ['id' => $product->id]) }}">{{ $product->title }}</a>
	</li>
</ul>
<!-- END PAGE BREADCRUMB -->
<!-- END PAGE HEADER-->
...
<script src="/admin/assets/pages/products/crazyify.products.entry.js" type="text/javascript"></script>
@endsection