...
@section('head.title', 'Chi tiết gia sư đăng ký')
...
<div class="page-head">
	...
	<div class="page-title">
		<h1>Chi tiết gia sư đăng ký <small>{{ $tutor->subject }}</small></h1>
	</div>
	<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<a href="{{ route('admin.tutors.edit', ['id' => $tutor->id]) }}">{{ $tutor->name }}</a>
	</li>
</ul>
<!-- END PAGE BREADCRUMB -->
<!-- END PAGE HEADER-->
	...
	<div class="col-md-12">
		<div class="portlet light bordered">
			<div class="portlet-body form">
				...
				{!! Form::open([
					'id' => 'tutor-form',
					'route' => ['admin.tutors.update', $tutor->id],
				...
				<div class="form-actions">
					<div class="row">
						<div class="col-md-offset-3 col-md-9">
							<a href="mailto:{{ $tutor->email }}" class="btn green-jungle"><i class="fa fa-envelope-o"></i>&nbsp;Trả lời email</a>
						</div>
					</div>
				</div>
				{!! Form::close() !!}
...
<script src="/admin/assets/pages/tutors/crazyify.tutors.entry.js" type="text/javascript"></script>
@endsection