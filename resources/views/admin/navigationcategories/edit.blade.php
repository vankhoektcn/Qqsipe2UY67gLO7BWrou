...
@section('head.title', 'Cập nhật danh mục liên kết')
...
<div class="page-head">
	...
	<div class="page-title">
		<h1>Danh mục liên kết <small>{{ $navigationCategory->name }}</small></h1>
	</div>
	<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<a href="{{ route('admin.navigationcategories.edit', ['id' => $navigationCategory->id]) }}">{{ $navigationCategory->name }}</a>
	</li>
</ul>
<!-- END PAGE BREADCRUMB -->
<!-- END PAGE HEADER-->
	...
	<div class="col-md-12">
		<div class="portlet light bordered">
			<div class="portlet-body form">
				...
				{!! Form::open([
					'id' => 'navigation-category-form',
					'route' => ['admin.navigationcategories.update', $navigationCategory->id],
...
<script src="/admin/assets/pages/navigationcategories/crazyify.navigationcategories.entry.js" type="text/javascript"></script>
@endsection