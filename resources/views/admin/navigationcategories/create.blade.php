...
@section('head.title', 'Tạo mới danh mục liên kết')
...
<div class="page-head">
	...
	<div class="page-title">
		<h1>Danh mục liên kết <small>Tạo mới</small></h1>
	</div>
	<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<a href="{{ route('admin.navigationcategories.create') }}">Tạo mới</a>
	</li>
</ul>
<!-- END PAGE BREADCRUMB -->
<!-- END PAGE HEADER-->
		...
		<div class="portlet light bordered">
			<div class="portlet-body form">
				...
				{!! Form::open([
					...
					'route' => 'admin.navigationcategories.store',
