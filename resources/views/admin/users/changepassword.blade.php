...
@section('head.title', 'Cập nhật mật mã tài khoản')
...
<div class="page-head">
	...
	<div class="page-title">
		<h1>Cập nhật mật mã tài khoản <small>{{ $user->name }}</small></h1>
	</div>
	<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<a href="{{ route('admin.users.changepassword') }}">Cập nhật mật mã tài khoản</a>
	</li>
</ul>
<!-- END PAGE BREADCRUMB -->
<!-- END PAGE HEADER-->
	...
	<div class="col-md-12">
		<div class="portlet light bordered">
			<div class="portlet-body form">
				...
				@include('admin.partials.flashedession')
				{!! Form::open([
...
<script src="/admin/assets/pages/users/crazyify.users.changepassword.js" type="text/javascript"></script>
@endsection