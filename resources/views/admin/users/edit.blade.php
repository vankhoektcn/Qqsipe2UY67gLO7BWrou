...
@section('head.title', 'Thông tin tài khoản')
...
<div class="page-head">
	...
	<div class="page-title">
		<h1>Thông tin tài khoản <small>{{ $user->name }}</small></h1>
	</div>
	<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<script src="/admin/assets/pages/users/crazyify.users.entry.js" type="text/javascript"></script>
@endsection