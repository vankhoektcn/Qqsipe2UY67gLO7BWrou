...
@section('head.title', 'Cập nhật danh mục dự án')
...
<div class="page-head">
	...
	<div class="page-title">
		<h1>Danh mục dự án <small>{{ $projectCategory->name }}</small></h1>
	</div>
	<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<a href="{{ route('admin.projectcategories.edit', ['id' => $projectCategory->id]) }}">{{ $projectCategory->name }}</a>
	</li>
</ul>
<!-- END PAGE BREADCRUMB -->
<!-- END PAGE HEADER-->
		...
		<div class="portlet light bordered">
			<div class="portlet-body form">
				...
				{!! Form::open([
					...
					'route' => ['admin.projectcategories.update', $projectCategory->id],
...
<script src="/admin/assets/pages/project_categories/crazyify.projectcategories.entry.js" type="text/javascript"></script>
@endsection