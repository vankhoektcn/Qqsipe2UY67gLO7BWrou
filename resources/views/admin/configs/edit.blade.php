...
@section('head.title', 'Cập nhật cấu hình hệ thống')
...
<div class="page-head">
	...
	<div class="page-title">
		<h1>Hệ thống <small>{{ $config->text }}</small></h1>
	</div>
	<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<a href="{{ route('admin.configs.index') }}">Hệ thống</a>
		<i class="fa fa-circle"></i>
	</li>
	<li>
		<a href="{{ route('admin.configs.edit', ['id' => $config->id]) }}">{{ $config->text }}</a>
	</li>
</ul>
<!-- END PAGE BREADCRUMB -->
<!-- END PAGE HEADER-->
	...
	<div class="col-md-12">
		<div class="portlet light bordered">
			<div class="portlet-body form">
				...
				{!! Form::open([
					'id' => 'config-form',
					'route' => ['admin.configs.update', $config->id],
...
<script src="/admin/assets/pages/configs/crazyify.configs.entry.js" type="text/javascript"></script>
@endsection