...
@section('head.title', 'Cập nhật liên kết')
...
<div class="page-head">
	...
	<div class="page-title">
		<h1>liên kết <small>{{ $navigation->name }}</small></h1>
	</div>
	<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<a href="{{ route('admin.navigations.edit', ['id' => $navigation->id]) }}">{{ $navigation->name }}</a>
	</li>
</ul>
<!-- END PAGE BREADCRUMB -->
<!-- END PAGE HEADER-->
	...
	<div class="col-md-12">
		<div class="portlet light bordered">
			<div class="portlet-body form">
				...
				{!! Form::open([
					'id' => 'navigation-form',
					'route' => ['admin.navigations.update', $navigation->id],
...
<script src="/admin/assets/pages/navigations/crazyify.navigations.entry.js" type="text/javascript"></script>
@endsection