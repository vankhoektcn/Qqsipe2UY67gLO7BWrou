...
@section('head.title', 'Cập nhật thông tin lịch học')
...
<div class="page-head">
	...
	<div class="page-title">
		<h1>Cập nhật thông tin lịch học <small>{{ $teachtime->key }}</small></h1>
	</div>
	<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<a href="{{ route('admin.teachtimes.edit', ['id' => $teachtime->id]) }}">{{ $teachtime->key }}</a>
	</li>
</ul>
<!-- END PAGE BREADCRUMB -->
<!-- END PAGE HEADER-->
	...
	<div class="col-md-12">
		<div class="portlet light bordered">
			<div class="portlet-body form">
				...
				{!! Form::open([
					'id' => 'teachtime-form',
					'route' => ['admin.teachtimes.update', $teachtime->id],
